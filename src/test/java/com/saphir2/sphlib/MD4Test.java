...
public class MD4Test extends AlgorithmTest {

  @Test
  public void testMD4() {
    Digest dig = new MD4();
    testDigestHexSource(dig, "", "31d6cfe0d16ae931b73c59d7e0c089c0");
    testDigestHexSource(dig, "a", "bde52cb31de33e46245e05fbdbd6fb24");
    testDigestHexSource(dig, "abc", "a448017aaf21d8525fc10ae87aa6729d");
    ...
    testDigestMillionA(dig, "bbce80cc6bb65e5c6745e30d4eeca9a4");
