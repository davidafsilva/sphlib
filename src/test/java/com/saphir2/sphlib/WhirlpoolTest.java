...
public class WhirlpoolTest extends AlgorithmTest {
  ...
  public void testWhirlpool() {
    ...
    testDigestHexSource(dig, "123456789012345678901234567890"
    ...
    testDigestHexSource(dig, "abcdbcdecdefdefgefghfghighijhijk",
    ...
    testDigestHexSource(dig0, "The quick brown fox jumps over the lazy dog",
    ...
    testDigestHexSource(dig0, "The quick brown fox jumps over the lazy eog",
    ...
    testDigestHexSource(dig1, "",
                        "470F0409ABAA446E49667D4EBE12A14387CEDBD10DD17B8243CAD550A089DC0F"
                        + "EEA7AA40F6C2AAAB71C6EBD076E43C7CFCA0AD32567897DCB5969861049A0F5A");
    testDigestHexSource(dig1, "The quick brown fox jumps over the lazy dog",
    ...
    testDigestHexSource(dig1, "The quick brown fox jumps over the lazy eog",
