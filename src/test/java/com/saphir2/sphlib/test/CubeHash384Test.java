...
import com.saphir2.sphlib.CubeHash384;

public class CubeHash384Test {

  @Test
  public void testCubeHash384() {
    TestSupportUtils.testKatHex(new CubeHash384(),
                                "",
    ...
    TestSupportUtils.reportSuccess("CubeHash-384");
  }
}
