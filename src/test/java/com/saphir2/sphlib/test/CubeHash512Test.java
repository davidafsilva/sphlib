...
import com.saphir2.sphlib.CubeHash512;

public class CubeHash512Test {

  @Test
  public void testCubeHash512() {
    TestSupportUtils.testKatHex(new CubeHash512(),
                                "",
    ...
    TestSupportUtils.reportSuccess("CubeHash-512");
  }
}
