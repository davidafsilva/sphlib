...
public class HMACTest extends AlgorithmTest {
  ...
  public void testHMAC() {
    Digest hmac;
         ...
         * From RFC 2104.
		 */
    hmac = new HMAC(new MD5(), strToBinary("0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B"));
    testDigestHexSource(hmac, "Hi There", "9294727A3638BB1C13F48EF8158BFC9D");
    hmac = new HMAC(new MD5(), "Jefe".getBytes());
    testDigestHexSource(hmac, "what do ya want for nothing?", "750C783E6AB0B503EAA86E310A5DB738");
    hmac = new HMAC(new MD5(), strToBinary("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"));
    testDigestHexSource(hmac, "\u00DD\u00DD\u00DD\u00DD\u00DD\u00DD\u00DD"
                              + "\u00DD\u00DD\u00DD\u00DD\u00DD\u00DD\u00DD\u00DD"
                              + "\u00DD\u00DD\u00DD\u00DD\u00DD\u00DD\u00DD\u00DD"
                              + "\u00DD\u00DD\u00DD\u00DD\u00DD\u00DD\u00DD\u00DD"
                              + "\u00DD\u00DD\u00DD\u00DD\u00DD\u00DD\u00DD\u00DD"
                              + "\u00DD\u00DD\u00DD\u00DD\u00DD\u00DD\u00DD\u00DD"
                              + "\u00DD\u00DD\u00DD",
                        "3949b2a75cb0101a71a71c28c0016cc3");

		/*
         * From FIPS 198a.
		 */
    hmac = new HMAC(new SHA1(),
                    strToBinary("000102030405060708090A0B0C0D0E0F101112131"
                                + "415161718191A1B1C1D1E1F20212223242526272"
                                + "8292A2B2C2D2E2F303132333435363738393A3B3"
                                + "C3D3E3F"));
    testDigestHexSource(hmac, "Sample #1",
                        "4F4CA3D5D68BA7CC0A1208C9C61E9C5DA0403C0A");

    hmac = new HMAC(new SHA1(),
                    strToBinary("303132333435363738393A3B3C3D3E3F40414243"));
    testDigestHexSource(hmac, "Sample #2",
                        "0922D3405FAA3D194F82A45830737D5CC6C75D24");

    hmac = new HMAC(new SHA1(),
                    strToBinary("505152535455565758595A5B5C5D5E5F606162636"
    ...
    testDigestHexSource(hmac, "Sample #3",
                        "BCF41EAB8BB2D802F3D05CAF7CB092ECF8D1A3AA");

    hmac = new HMAC(new SHA1(),
                    strToBinary("707172737475767778797A7B7C7D7E7F808182838"
                                + "485868788898A8B8C8D8E8F90919293949596979"
                                + "8999A9B9C9D9E9FA0"), 12);
    testDigestHexSource(hmac, "Sample #4",
